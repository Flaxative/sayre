...
Crafty.scene('Game', function() {
  ...
  // BURNINATOR
  NPCname = "Old Man 2";
  this.npc2 = Crafty.e('NPC').at(2, 1).color('#63f9ff').attr({name: NPCname, interact: "torchBushes()"}); world[2][1]=3;
...
Crafty.scene('west1', function() {
    ...
    Crafty.e('RockP').at(8, 3).attr({slide: "left", minX: 280, minY: 119, maxX: 321, maxY: 161, interact: 'tell("lol");hidden_passage1()'});
    world[8][3] = 3;
