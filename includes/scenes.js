...
Crafty.scene('north1', function() {
    ...
    // OLD MAN
    NPCname = "Woodsman";
    this.npc = Crafty.e('NPC').at(2, 4).attr({name: NPCname, interact: "dialogue('Hello! ... <br />That block over there sure looks heavy, dontcha think?', '"+NPCname+"')"});
    this.occupied[this.npc.at().x][this.npc.at().y] = true;
